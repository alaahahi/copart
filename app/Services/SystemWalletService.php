...

{
     ...
     * Legacy client-type rows used as company vaults (not real merchants).
...

    {
        ...
        return ['مصاريف الشركة', 'Company Expenses'];
     ...
     * Covers type=account wallets + legacy client vaults like «مصاريف الشركة».
...

    {
        ...
        return $name !== '' && in_array($name, self::legacyClientVaultNames(), true);
