...
// Load the client being edited (including its current عرض بالمحاسبة flag)
      ...
      <div class="erp-modal-panel">
        <header class="erp-modal-header">
          <div class="erp-modal-header-text">
            ...
            <h2 id="edit-client-title" class="erp-modal-title">تعديل بيانات التاجر</h2>
            <p class="erp-modal-subtitle">{{ form.name || 'تحديث اسم ورقم هاتف التاجر' }}</p>
          </div>
        ...
        <div class="erp-modal-body">
          <div class="erp-field">
            <label class="erp-label" for="edit-client-name">{{ $t('name') }}</label>
            <input
              id="edit-client-name"
              v-model="form.name"
              type="text"
          ...
          <div class="erp-field">
            <label class="erp-label" for="edit-client-phone">{{ $t('phone') }}</label>
            <input
          ...
          <div class="erp-toggle-row">
            <div class="erp-toggle-text">
              ...
              <span class="erp-toggle-hint">يُظهر التاجر في اختصارات المحاسبة ويُنشئ حسابات ذمم إضافية — ليس قاصة نظام. إيقاف العرض لا يحذف الحسابات التاريخية.</span>
            </div>
