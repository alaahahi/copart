    ...
    <div v-if="show" class="car-modal-overlay">
      <div class="car-modal-panel">
        ...
        <div class="car-modal-body">
          <!-- Section: التاجر -->
          <section class="car-section" v-if="!formData.id">
            ...
            <div v-if="!showClient" class="flex flex-col sm:flex-row sm:items-end gap-3">
              ...
              <button
                ...
                @click="
                  ...
                  formData.client_id='';
                "
                class="car-btn car-btn-success shrink-0"
              >
            ...
            <div v-else class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label class="car-label" for="client_name">{{ $t("car_owner") }}</label>
                <input
                  id="client_name"
                  type="text"
                  class="car-input"
              ...
              <div>
                <label class="car-label" for="client_phone">
                  {{ $t("phoneNumber") }}
                </label>
                <input
                  id="client_phone"
