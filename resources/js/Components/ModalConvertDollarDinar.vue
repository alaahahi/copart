...
function calculateAmountDollarDinar() {
  ...
  const usd = Number(form.value.amountDollar);
  if (!rate || !usd || exchangeRateError.value) {
    form.value.amountResultDinar = '';
    return;
  }
  form.value.amountResultDinar = Math.floor(usd * (rate / 100));
}
...
<template>
  <Transition name="erp-modal">
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="convert-usd-title"
      @click.self="emit('close')"
    >
      <div class="erp-modal-panel">
        <header class="erp-modal-header erp-modal-header--convert">
          <div class="erp-modal-header-text">
            <p class="erp-modal-eyebrow">صرف العملات</p>
            <h2 id="convert-usd-title" class="erp-modal-title">تحويل دولار إلى دينار</h2>
            <p class="erp-modal-subtitle">سحب من صندوق الدولار وإضافة إلى صندوق الدينار</p>
          </div>
        ...
        <div class="erp-modal-body">
          ...
          <div class="erp-field">
            <label class="erp-label" for="usd-rate">سعر الصرف لكل 100$</label>
            <input
              id="usd-rate"
          ...
          <div class="erp-field">
            <label class="erp-label" for="usd-amount">
              المبلغ بالدولار
          ...
          <div class="erp-result">
            ...
            <div class="erp-result-value">
              <input
                ...
                aria-label="المبلغ الناتج بالدينار"
              />
              <span class="erp-result-unit">د.ع</span>
            </div>
          </div>
        </div>
...
.erp-result {
  ...
  background: linear-gradient(145deg, #052e16 0%, #0f172a 70%);
