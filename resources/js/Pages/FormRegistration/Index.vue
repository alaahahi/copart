                            ...
                            <div class="basis-1/2">
                                <form class="flex items-center max-w-5xl">   
                                    ...
                                    <div class="erp-search relative w-full">
                                        ...
                                        <input   v-model="searchTerm" @input="search(searchTerm)" type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 erp-search__input block w-full py-2.5 pe-3  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="بحث حسب رقم الوصل او رقم البطاقة او اسم المشترك" required>
                                    </div>
                                    </form>
                            </div>
                </div>
