...
<head>
@include('Components.reportHead', ['pageTitle' => 'تقرير الدفعات'])
</head>
<body class="erp-report">
@include('Components.reportToolbar')
<div class="erp-report-page">
@include('Components.reportHeader', ['title' => 'تقرير الدفعات', 'config' => $config ?? null])
    ...
    <div class="erp-report-summary">
        ...
        <div class="erp-report-summary__card">
            ...
            <span class="erp-report-summary__value num">{{ $clientData['cars_sum'] - $clientData['client']['wallet']['balance'] }}</span>
        </div>
        <div class="erp-report-summary__card">
            <span class="erp-report-summary__label">المبلغ المتبقي</span>
            <span class="erp-report-summary__value num">{{ $clientData['client']['wallet']['balance'] }}</span>
        </div>
